...
export type OrderDelivery = {
  ...
  /**
   * Заказ везём сами — решение менеджера уже после оформления. Город
   * при этом остаётся прежним: покупатель выбирал его сам, и подменять
   * выбранный пункт выдачи задним числом нельзя.
   */
