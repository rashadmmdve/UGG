 ...
 */
export const SITE_NAME = "ОРИГИНАЛЬНЫЕ UGG";

export const SITE_DESCRIPTION =
  "Магазин оригинальной обуви UGG®. Классические угги, тапочки и аксессуары " +
  "с доставкой по России. Гарантия подлинности, обмен и возврат 14 дней.";

/**
 * Дисклеймер о независимости от правообладателя. Выводится в подвале
 * каждой страницы. Это не формальность: именно он отличает добросовестного
 * продавца оригинального товара от того, кто выдаёт себя за официального
 * представителя. Формулировку менять только вместе с юристом.
 */
export const TRADEMARK_DISCLAIMER =
  ...
  "Мы — независимый продавец оригинальной продукции UGG®.";
