 ...
 * ФФД 1.2, здесь везде «штука».
 *
 * Признак предмета расчёта — «товар» (commodity), а не «маркированный
 * товар» (marked): кодов маркировки «Честного знака» на этот товар нет,
 * и решение владельца — продавать как немаркируемый. Поэтому в чеке нет
 * mark_code_info, а в накладной СДЭК не заполняется поле marking. Если
 * коды появятся, менять придётся оба места сразу — иначе чек ЮKassa и
