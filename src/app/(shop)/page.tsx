...
export const metadata: Metadata = {
  title: { absolute: `${SITE_NAME} — магазин оригинальной обуви UGG®` },
  ...
  return (
    <>
      ...
      <section className="container-page mt-10">
        <ul className="grid gap-3 rounded-xl border border-line bg-sand p-4 text-sm sm:grid-cols-2 lg:grid-cols-4">
          <li><span className="font-semibold">Только оригинал</span><span className="block text-xs text-muted">Прямые поставки, документы на каждую партию</span></li>
